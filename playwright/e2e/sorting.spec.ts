...
test.describe('sorting', () => {
  test.describe('client side sorting', () => {
    ...
    test(example, async ({ si, page }) => {
      ...
      await expect(firstRow.getByRole('cell', { name: 'Accidency' })).toBeTruthy();
      ...
      await expect(firstRow.getByRole('cell', { name: 'Zolar' })).toBeTruthy();
  ...
  test.describe('default sorting', () => {
    ...
    test(example, async ({ si, page }) => {
      ...
      await expect(firstRow.getByRole('cell', { name: 'Yvonne Parsons' })).toBeTruthy();
      ...
      await expect(firstRow.getByRole('cell', { name: 'Alexander Foley' })).toBeTruthy();
      ...
      await expect(firstRow.getByRole('cell', { name: 'Ethel Price' })).toBeTruthy();
  ...
  test.describe('server side sorting', () => {
    ...
    test(example, async ({ si, page }) => {
      ...
      await expect(firstRow.getByRole('cell', { name: 'Aquamate' })).toBeTruthy();
      ...
      await expect(firstRow.getByRole('cell', { name: 'Xyqag' })).toBeTruthy();
