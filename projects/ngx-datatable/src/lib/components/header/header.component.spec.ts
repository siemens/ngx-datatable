...
describe('DataTableHeaderComponent', () => {
  ...
  it('should allow resizing columns', async () => {
    ...
    const firstCell = resizeHandles[0].nativeElement;
    ...
    const mouseMove = new MouseEvent('mousemove', { clientX: 200, screenX: 200 });
    document.dispatchEvent(mouseMove);

    const mouseUp = new MouseEvent('mouseup', { clientX: 200, screenX: 200 });
